...
public:
  ...
  void enableCompleteness(bool ec = true) {
    ui.lb_completeness_val->setEnabled(ec);
    ui.lb_completeness->setEnabled(ec);
  };
  ...
  void setComplete(QString s) { ui.lb_completeness_val->setText(s); };
  /// Sets the text of the 'states reachable' label (percentage)
  void setStatesReachable(QString s) {
    ui.lb_statesreachable_val->setText(s);
  };
  /// Sets the text of the 'end states reachable' label (percentage)
  void setFinalStatesReachable(QString s) {
    ui.lb_endstatesreachable_val->setText(s);
  };
  /// Sets the text of the 'transitions connected' label (percentage)
  void setTransConnected(QString s) {
    ui.lb_transconnected_val->setText(s);
  };
  /// Sets the protocol text
  void setProtocolText(QString t) { ui.tb_protocol->setText(t); }

...
public:
 ...
 void getMovedBy(double& x, double& y)
 {
  ...
  void getMachineInfo(Machine *&m, QString &n, int &t, int &nb,
                      QStringList &olistm, int &ni, QStringList &ilist, int &no,
                      QStringList &olist, QFont &sf, QFont &tf, int &at,
                      bool &dit);
  void setMachineInfo(Machine *m, QString n, int t, int nb, QStringList olistm,
                      int ni, QStringList ilist, int no, QStringList olist,
                      QFont sf, QFont tf, int at, bool dit);
...
private:
  ...
  /// Copy of pointers to save the order of the copied transitions (Change
  /// state)

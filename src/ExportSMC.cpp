...
ExportSMC::ExportSMC(Options *opt) : Export(opt) {}

/// Writes all the relevant data into the tdf file.
void ExportSMC::doExport() { writeMain(); }

QString ExportSMC::fileFilter() { return "SMC (*.sm)"; }
QString ExportSMC::defaultExtension() { return "sm"; }

...
int LBArrowLine::height(const Q3ListBox *) const { return 30; }

/// Returns the width of the listbox item
int LBArrowLine::width(const Q3ListBox *) const { return 30; }
...
int LBArrowFilled::height(const Q3ListBox *) const { return 30; }

/// Returns the width of the listbox
int LBArrowFilled::width(const Q3ListBox *) const { return 30; }
...
void LBArrowFilled::paint(QPainter *p) {
  ...
  pa.setPoints(3, ofx + 20, ofy, ofx + le + 20, ofy + wi, ofx + 20,
               ofy + 2 * wi);
...
/// Returns the height of the listbox
int LBArrowWhite::height(const Q3ListBox *) const { return 30; }

/// Returns the width of the listbox
int LBArrowWhite::width(const Q3ListBox *) const { return 30; }
...
/// Returns the height of the listbox
int LBArrowFilledPointed::height(const Q3ListBox *) const { return 30; }

/// Returns the width of the listbox
int LBArrowFilledPointed::width(const Q3ListBox *) const { return 30; }
...
void LBArrowFilledPointed::paint(QPainter *p) {
  ...
  pa.setPoints(4, ofx + 20, ofy, ofx + le + 20, ofy + wi, ofx + 20,
               ofy + 2 * wi, ofx + 20 + int(0.33 * le), ofy + wi);
...
/// Returns the height of the listbox
int LBArrowWhitePointed::height(const Q3ListBox *) const { return 30; }

/// Returns the width of the listbox
int LBArrowWhitePointed::width(const Q3ListBox *) const { return 30; }

 ...
 * @a o is a pointer to the output stream opened with the standard fstream
 * methods.
 */
// void Export::init(std::ofstream* o, Machine* m, QString fn/*=QString::null*/,
// ScrollView* sv/*=NULL*/)

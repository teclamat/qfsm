...
/**
 * @class DrawArea
 * @brief Stores all the information concerning the drawing area (inside the
 * scroll view) and is responsible for the user interaction.
 */
...
private:
  ...
  /// X coordinate of the last clicked position of the first control point of a
  /// transition
  double lastMovePosCont1X;
  /// Y coordinate of the last clicked position of the first control point of a
  /// transition
  double lastMovePosCont1Y;
  /// X coordinate of the last clicked position of the second control point of a
  /// transition
  double lastMovePosCont2X;
  /// Y coordinate of the last clicked position of the second control point of a
  /// transition
  ...
  /// X coordinate of the last position of the first control point of a
  /// transition
  double lastCont1X;
  /// Y coordinate of the last position of the first control point of a
  /// transition
  double lastCont1Y;
  /// X coordinate of the last position of the second control point of a
  /// transition
  double lastCont2X;
  /// Y coordinate of the last position of the second control point of a
  /// transition
  double lastCont2Y;
  /// Last bounding rectangle of the descriptor text ("Reset") of the initial
  /// transition
  QRect lastITextRect;

  /// Pointer to the state that was clicked most recently (with the left mouse
  /// button)
  GState *lastStateClicked;
  /// Pointer to the object that was clicked most recently (with the right mouse
  /// button)
